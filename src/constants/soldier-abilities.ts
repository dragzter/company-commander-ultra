...
export const SHIELD_ICON =
  "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cdefs%3E%3ClinearGradient id='sh' x1='0%25' y1='0%25' x2='0%25' y2='100%25'%3E%3Cstop offset='0%25' stop-color='%234ade80'/%3E%3Cstop offset='100%25' stop-color='%2316a34a'/%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath fill='url(%23sh)' stroke='%230ea54b' stroke-width='1.2' stroke-linejoin='round' d='M12 2L2 6v8c0 6 4.5 8.5 10 11s10-5 10-11V6L12 2z'/%3E%3Cpath fill='none' stroke='%23fff' stroke-width='1.1' stroke-linecap='round' opacity='0.85' d='M12 6v10m-4-6l4-2 4 2m-8 4l4 2 4-2'/%3E%3C/svg%3E";
