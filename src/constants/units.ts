...
import { FACTION_IDENTIFIERS, TRAITS } from "./identifiers.ts";
...
export const UNITS: Record<string, Record<string, Unit>> = {
  desert_wolves: {
    ashcroft_infantry_brigade_42: {
      ...
      nickname: "The Pack",
      allegiance: FACTION_IDENTIFIERS.desert_wolves,
      traits: [
  ...
  iron_corps: {
    mechanized_scouts_5: {
      ...
      nickname: "Chargers",
      allegiance: FACTION_IDENTIFIERS.iron_corps,
      traits: [
        TRAIT_EFFECT_CONFIGURATION[TRAITS.aggressive],
        TRAIT_EFFECT_CONFIGURATION[TRAITS.impatient],
        TRAIT_EFFECT_CONFIGURATION[TRAITS.relentless],
  ...
  liberties_vanguard: {
    infantry_regiment_4: {
      ...
      allegiance: FACTION_IDENTIFIERS.liberties_vanguard,
      traits: [
        TRAIT_EFFECT_CONFIGURATION[TRAITS.flexible],
        TRAIT_EFFECT_CONFIGURATION[TRAITS.aggressive],
        TRAIT_EFFECT_CONFIGURATION[TRAITS.cautious],
  ...
  scarlet_accord: {
    infantry_regiment_19: {
      ...
      nickname: "Warriors",
      allegiance: FACTION_IDENTIFIERS.scarlet_accord,
      traits: [
        TRAIT_EFFECT_CONFIGURATION[TRAITS.aggressive],
        TRAIT_EFFECT_CONFIGURATION[TRAITS.fortified],
        TRAIT_EFFECT_CONFIGURATION[TRAITS.relentless],
