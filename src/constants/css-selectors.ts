export const DOM = {
  ...
  company: {
    ...
    settings: "#company-go-settings",
    resumeTutorial: "#company-resume-tutorial",
    tutorialDismiss: "#tutorial-progress-dismiss",
    statsMemorial: "#company-stats-memorial",
    settingsPopup: "#settings-popup",
    settingsPopupClose: "#settings-popup-close",
    settingsSquadNameInput: "#settings-squad-name-input",
    settingsSquadNameCounter: "#settings-squad-name-counter",
    settingsSquadNameSave: "#settings-squad-name-save",
    settingsSquadNameStatus: "#settings-squad-name-status",
    settingsMusicToggle: "#settings-music-toggle",
    settingsSfxToggle: "#settings-sfx-toggle",
    ...
    onboardingMedicPopup: "#home-medic-onboarding-popup",
    onboardingMedicContinue: "#home-medic-onboarding-continue",
    onboardingMissionTypesPopup: "#missions-types-onboarding-popup",
    onboardingMissionTypesContinue: "#missions-types-onboarding-continue",
    onboardingSuppliesIntroPopup: "#home-supplies-onboarding-popup",
    onboardingSuppliesIntroContinue: "#home-supplies-onboarding-continue",
    onboardingSuppliesMarketPopup: "#supplies-market-onboarding-popup",
    onboardingSuppliesMarketContinue: "#supplies-market-onboarding-continue",
  ...
  setupScreen: {
    ...
    commanderCounter: "#commander-name-counter",
    companyCounter: "#company-name-counter",
    commanderStatus: "#commander-name-status",
    companyStatus: "#company-name-status",
  ...
  missions: {
    ...
    filterChipBtn: ".missions-filter-chip",
  ...
  readyRoom: {
    ...
    missionsBtn: "#ready-room-missions",
    restBtn: "#ready-room-rest-btn",
    onboardingPopup: "#ready-room-onboarding-popup",
    onboardingContinue: "#ready-room-onboarding-continue",
  },
  combat: {
    beginBtn: "#combat-begin",
    backToReadyRoomBtn: "#combat-back-ready-room",
