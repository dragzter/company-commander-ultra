...
import {
  applyPostCapWeaponDamage,
  clampGearLevel,
  scaleWeaponBonusesToPreCapLevel,
} from "./gear-scaling.ts";
...
export const RARE_WEAPON_BASES: RareWeaponBase[] = [
  {
    baseId: "storm_carbine",
    name: "Storm Carbine",
    description:
      "Preferred by tactical units" + " that hit hard and move fast.",
    icon: "weapon_29.png",
    damageMinBase: 11,
    damageMaxBase: 18,
    damagePerLevel: 2,
    ...
    bonuses: [
      { type: "flat", stat: "dex", value: 5 },
      { type: "flat", stat: "awareness", value: 3 },
    ],
  },
  {
    baseId: "veteran_war_rifle",
    name: "Veteran War Rifle",
    description: "Refitted and rebuilt. Still knows how to kill.",
    icon: "weapon_39.png",
    damageMinBase: 19,
    damageMaxBase: 26,
    damagePerLevel: 2,
    ...
    restrictRole: "rifleman",
    bonuses: [
      { type: "flat", stat: "awareness", value: 7 },
      {
        type: "flat",
        stat: "toughness",
        value: 5,
  ...
  },
  {
    baseId: "stinger_smg",
    name: "Stinger SMG",
    description: "Favored by close-quarters specialists.",
    icon: "weapon_14.png",
    damageMinBase: 8,
    damageMaxBase: 14,
    damagePerLevel: 2,
    ...
    damage_type: "ballistic",
    restrictRole: "rifleman",
    bonuses: [{ type: "flat", stat: "dex", value: 7 }],
  },
  {
    baseId: "marksman_dmr",
    name: "Marksman DMR",
    description: "A sharpshooter's trusted companion.",
    icon: "weapon_34.png",
    damageMinBase: 14,
    damageMaxBase: 20,
    damagePerLevel: 2,
    ...
    damage_type: "ballistic",
    restrictRole: "rifleman",
    bonuses: [{ type: "flat", stat: "awareness", value: 7 }],
  },
  {
    baseId: "suppressor_mg",
    name: "Suppressor LMG",
    description: "Keeps the enemy pinned when the push goes in.",
    icon: "weapon_45.png",
    damageMinBase: 21,
    damageMaxBase: 29,
    damagePerLevel: 4,
    ...
    bonuses: [
      { type: "flat", stat: "toughness", value: 5 },
      {
        type: "flat",
        stat: "awareness",
        value: 4,
  ...
  {
    baseId: "field_medic_smg",
    name: "Field Medic SMG",
    description: "Light enough to run with, reliable when it matters.",
    icon: "weapon_2.png",
    damageMinBase: 10,
    damageMaxBase: 16,
    damagePerLevel: 2,
...
export function createRareWeapon(base: RareWeaponBase, level: GearLevel) {
  ...
  const bonuses =
    scaleWeaponBonusesToPreCapLevel(base.bonuses, preCapLevel) ?? base.bonuses;
  return {
