...
export const RARE_WEAPON_BASES: RareWeaponBase[] = [
  ...
  { baseId: "veteran_war_rifle", name: "Veteran War Rifle", description: "Refitted and rebuilt. Still knows how to kill.", icon: "weapon_39.png", damageMinBase: 18, damageMaxBase: 25, damagePerLevel: 2, speed_base: 3, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "awareness", value: 6 }, { type: "flat", stat: "toughness", value: 4 }] },
