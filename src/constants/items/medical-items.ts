...
export const MedicalItems: ItemsVolume<MedItem> = {
  common: {
    standard_medkit: {
      ...
      rarity: "common",
      description: "The medic's companion. Stops bleeding and keeps soldiers in the fight.",
      usable: true,
      icon: "med_kit.png",
      uses: 5,
      target: "friendly",
  ...
  rare: {
    orange_stim_pack: {
      ...
      type: ITEM_TYPES.medical,
      rarity: "common",
      description: "Concentrated healing serum. One shot, all in.",
      usable: true,
      uses: 1,
      target: "friendly",
      tags: ["medical"],
    ...
    adrenaline_injection: {
      ...
      type: ITEM_TYPES.medical,
      rarity: "common",
      description: "Synthetic edge. Sharpens reflexes, dulls the rest.",
      usable: true,
      uses: 1,
      target: "friendly",
      tags: ["medical"],
  ...
  epic: {
    substance_m: {
      ...
      type: ITEM_TYPES.medical,
      rarity: RARITY.epic,
      description: "Lost pre-war compound. Brings the dead back—at a price.",
      usable: true,
      uses: 1,
      target: "friendly",
      tags: ["medical"],
