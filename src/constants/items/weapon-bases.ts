...
export const WEAPON_BASES: WeaponBase[] = [
  ...
  },
  {
    ...
    damageMinBase: 12,
    damageMaxBase: 16,
    damagePerLevel: 21 / 19,
    speed_base: 2,
    damage_type: "ballistic",
    restrictRole: "rifleman",
  },
  {
    baseId: "double_barrel_shotgun",
  ...
  {
    baseId: "m42_pistol_carbine",
    name: "M42 Pistol Carbine",
    description: "A staple in the spec ops community.",
    icon: "weapon_2.png",
    damageMinBase: 2,
    damageMaxBase: 5,
    damagePerLevel: 18 / 19,
    speed_base: 8,
    damage_type: "ballistic",
    restrictRole: "any",
  },
  {
    baseId: "lsaw_guardsman",
    name: "LSAW Guardsman Rifle",
    description: "For the professional on the move.",
    icon: "weapon_34.png",
    damageMinBase: 11,
    damageMaxBase: 16,
    damagePerLevel: 2,
  ...
  {
    baseId: "akpd_assault",
    name: "AK PD-2 Assault",
    description: "Based on the venerable AK-47 lineage.",
    icon: "weapon_14.png",
    weaponSfx: "audio/weapons/mg_burts_2.m4a",
    damageMinBase: 2,
    damageMaxBase: 7,
    damagePerLevel: 1,
    speed_base: 8,
  ...
  {
    baseId: "m240_delta",
    name: "M240 Delta Pattern MG",
    description: "Tried and true squad assault weapon.",
    icon: "weapon_45.png",
    weaponSfx: "audio/weapons/heavy_mg_1.m4a",
    damageMinBase: 12,
    damageMaxBase: 17,
    damagePerLevel: 2,
    speed_base: 4,
  ...
  },
  {
    baseId: "compact_smg",
    name: "Compact SMG",
    description: "Trusted by medics who need to keep their hands free.",
    icon: "weapon_2.png",
    weaponSfx: "audio/weapons/mg_burst_3.m4a",
    damageMinBase: 4,
    damageMaxBase: 7,
    damagePerLevel: 1,
    speed_base: 7,
  ...
  {
    baseId: "r99_battle_rifle",
    name: "R99 Battle Rifle",
    description: "A marksman's choice for mid-range engagements.",
    icon: "weapon_34.png",
    damageMinBase: 7,
    damageMaxBase: 11,
    damagePerLevel: 1,
