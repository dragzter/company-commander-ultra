...
export const WEAPON_BASES: WeaponBase[] = [
  { baseId: "m5_assault_rifle", name: "M5 Assault Rifle", description: "Standard-issue. Every soldier knows how to use one.", icon: "weapon_57.png", damageMinBase: 7, damageMaxBase: 10, damagePerLevel: 22 / 19, speed_base: 5, damage_type: "ballistic", restrictRole: "any" },
  ...
  { baseId: "m42_pistol_carbine", name: "M42 Pistol Carbine", description: "A staple in the spec ops community.", icon: "weapon_2.png", damageMinBase: 2, damageMaxBase: 5, damagePerLevel: 18 / 19, speed_base: 8, damage_type: "ballistic", restrictRole: "any" },
...
export function createWeapon(base: WeaponBase, level: GearLevel) {
  ...
  if (tier > BASE_GEAR_LEVEL_CAP) {
    const boosted = applyPostCapWeaponDamage(damageMin, damageMax, tier, { rarity: RARITY.common, baseId: base.baseId });
