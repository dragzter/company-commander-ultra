...
export const EPIC_WEAPON_BASES: EpicWeaponBase[] = [
  { baseId: "titan_slam", name: "Titan Slam", description: "Close range, no quarter.", icon: "weapon_44.png", damageMinBase: 22, damageMaxBase: 35, damagePerLevel: 3.5, speed_base: 2, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "toughness", value: 6 }, { type: "flat", stat: "awareness", value: 5 }], weaponEffect: "heavy_caliber", storeAvailable: false },
  { baseId: "phantom_rifle", name: "Phantom Rifle", description: "Favored by infiltrators who never miss.", icon: "weapon_50.png", damageMinBase: 16, damageMaxBase: 22, damagePerLevel: 2.2, speed_base: 7, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "dex", value: 6 }, { type: "flat", stat: "awareness", value: 5 }], weaponEffect: "eagle_eye", storeAvailable: false },
  ...
  { baseId: "reaper_hmg", name: "Reaper HMG", description: "The sound of incoming fire.", icon: "weapon_55.png", damageMinBase: 25, damageMaxBase: 35, damagePerLevel: 3.6, speed_base: 4, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "toughness", value: 7 }], weaponEffect: "padded", storeAvailable: false },
  { baseId: "savior_smg", name: "Savior SMG", description: "Medics who carry this don't go down without a fight.", icon: "weapon_2.png", damageMinBase: 12, damageMaxBase: 16, damagePerLevel: 2.1, speed_base: 9, damage_type: "ballistic", restrictRole: "medic", bonuses: [{ type: "flat", stat: "dex", value: 7 }, { type: "flat", stat: "morale", value: 10 }], weaponEffect: "trauma_surgeon", storeAvailable: false },
  ...
  { baseId: "executioner_lmg", name: "Executioner LMG", description: "Sustained fire that ends fights.", icon: "weapon_45.png", damageMinBase: 21, damageMaxBase: 28, damagePerLevel: 3.2, speed_base: 5, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "toughness", value: 6 }, { type: "flat", stat: "awareness", value: 4 }], weaponEffect: "stormhammer", storeAvailable: false },
  { baseId: "nullifier_lmg", name: "Nullifier LMG", description: "Evasive targets learn to fear it.", icon: "weapon_49.png", damageMinBase: 21, damageMaxBase: 28, damagePerLevel: 3.4, speed_base: 5, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "toughness", value: 5 }, { type: "flat", stat: "awareness", value: 6 }], weaponEffect: "target_acquired", storeAvailable: false },
  { baseId: "guardian_smg", name: "Guardian SMG", description: "Swift in the hands of those who save lives.", icon: "weapon_14.png", damageMinBase: 12, damageMaxBase: 19, damagePerLevel: 2.3, speed_base: 8, damage_type: "ballistic", restrictRole: "medic", bonuses: [{ type: "flat", stat: "dex", value: 6 }, { type: "flat", stat: "morale", value: 8 }], weaponEffect: "balanced", storeAvailable: false },
  ...
  { baseId: "hm45_assault_carbine", name: "HM 45 Assault Carbine", description: "Overwhelms before the enemy can react.", icon: "weapon_23.png", damageMinBase: 16, damageMaxBase: 23, damagePerLevel: 2.6, speed_base: 4, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "morale", value: 20 }, { type: "flat", stat: "hp", value: 10 }], weaponEffect: "overwhelm", storeAvailable: false },
  { baseId: "the_butcher", name: "The Butcher", description: "Named for what it does to its targets.", icon: "weapon_56.png", damageMinBase: 22, damageMaxBase: 30, damagePerLevel: 3.5, speed_base: 4, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "toughness", value: 20 }], weaponEffect: "eviscerate", storeAvailable: false },
];
