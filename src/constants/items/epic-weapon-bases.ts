...
export const EPIC_WEAPON_BASES: EpicWeaponBase[] = [
  ...
  { baseId: "reaper_hmg", name: "Reaper HMG", description: "The sound of incoming fire.", icon: "weapon_55.png", damageMinBase: 28, damageMaxBase: 38, damagePerLevel: 4, speed_base: 4, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "toughness", value: 7 }], weaponEffect: "padded", storeAvailable: false },
