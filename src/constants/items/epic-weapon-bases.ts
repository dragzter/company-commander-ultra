...
export const EPIC_WEAPON_BASES: EpicWeaponBase[] = [
  ...
  { baseId: "phantom_rifle", name: "Phantom Rifle", description: "Elite infiltrator rifle. Fast, precise, deadly.", icon: "weapon_50.png", damageMinBase: 15, damageMaxBase: 21, damagePerLevel: 2, speed_base: 7, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "dex", value: 6 }, { type: "flat", stat: "awareness", value: 5 }], weaponEffect: "eagle_eye", storeAvailable: false },
  { baseId: "predator_rifle", name: "Predator Rifle", description: "Epic precision rifle. Locks onto evasive targets.", icon: "weapon_34.png", damageMinBase: 16, damageMaxBase: 24, damagePerLevel: 2, speed_base: 5, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "awareness", value: 8 }], weaponEffect: "target_acquired", storeAvailable: false },
  { baseId: "reaper_hmg", name: "Reaper HMG", description: "Epic heavy machine gun. Unmatched suppression.", icon: "weapon_55.png", damageMinBase: 28, damageMaxBase: 38, damagePerLevel: 4, speed_base: 4, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "toughness", value: 7 }], weaponEffect: "steady_grip", storeAvailable: false },
  ...
  { baseId: "nullifier_lmg", name: "Nullifier LMG", description: "Epic LMG. Tracks and punishes evasive targets.", icon: "weapon_55.png", damageMinBase: 22, damageMaxBase: 30, damagePerLevel: 4, speed_base: 5, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "toughness", value: 5 }, { type: "flat", stat: "awareness", value: 6 }], weaponEffect: "target_acquired", storeAvailable: false },
  { baseId: "guardian_smg", name: "Guardian SMG", description: "Epic medic SMG. Swift and evasive.", icon: "weapon_14.png", damageMinBase: 11, damageMaxBase: 17, damagePerLevel: 2, speed_base: 8, damage_type: "ballistic", restrictRole: "medic", bonuses: [{ type: "flat", stat: "dex", value: 6 }, { type: "flat", stat: "morale", value: 8 }], weaponEffect: "balanced", storeAvailable: false },
  { baseId: "m17_rifle", name: "M17", description: "Epic heavy rifle. Devastating single shots.", icon: "weapon_32.png", damageMinBase: 19, damageMaxBase: 27, damagePerLevel: 3, speed_base: 5, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "percent", stat: "chanceToHit", value: 1 }], weaponEffect: "carnage", storeAvailable: false },
  { baseId: "pulse_rifle", name: "Pulse Rifle", description: "Stabilized battle rifle. Excellent awareness and toughness.", icon: "weapon_27.png", damageMinBase: 15, damageMaxBase: 21, damagePerLevel: 2, speed_base: 3, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "awareness", value: 10 }, { type: "flat", stat: "toughness", value: 20 }], weaponEffect: "focused", storeAvailable: false },
  { baseId: "hm45_assault_carbine", name: "HM 45 Assault Carbine", description: "Epic support carbine. Overwhelms enemies.", icon: "weapon_23.png", damageMinBase: 14, damageMaxBase: 20, damagePerLevel: 2, speed_base: 4, damage_type: "ballistic", restrictRole: "support", bonuses: [{ type: "flat", stat: "morale", value: 20 }, { type: "flat", stat: "hp", value: 10 }], weaponEffect: "overwhelm", storeAvailable: false },
  { baseId: "the_butcher", name: "The Butcher", description: "Epic heavy caliber machine gun. Shreds targets.", icon: "weapon_56.png", damageMinBase: 24, damageMaxBase: 32, damagePerLevel: 4, speed_base: 4, damage_type: "ballistic", restrictRole: "rifleman", bonuses: [{ type: "flat", stat: "toughness", value: 20 }], weaponEffect: "eviscerate", storeAvailable: false },
];
