  ...
  <div class="card-body">
    <div class="card-row card-row-1">
      ...
      <div class="card-title-block">
        ...
        <button type="button" class="roster-traits-chip" data-soldier-id="${soldier.id}" data-soldier-name="${escapeAttr(formatDisplayName(soldier.name))}" title="View soldier traits and status effects">Traits</button>
      </div>
    </div>
    <div class="card-row card-row-2">
